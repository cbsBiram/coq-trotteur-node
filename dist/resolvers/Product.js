...
let ProductResolver = class ProductResolver {
    ...
    ;
    createProduct({ title, price, image }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateProduct(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const product = yield Products_1.ProductModel.findById({ _id: id });
            if (!product)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, product_input_1.ProductInput]),
    __metadata("design:returntype", Promise)
